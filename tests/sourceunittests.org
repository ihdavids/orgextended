...
* Result Checks
  ...
  #+TBLFM:@2$4=passed(sbe('row-sums')[0] == 15 and sbe('row-sums')[1] == 40)::@3$4=passed(sbe('list-sums')[0] == 6)::@2$3=sbe('row-sums')::@3$3=sbe('list-sums')::@5$2=sbe('plantuml-test')::@5$3=sbe('file-exists',filename=filename(@5$2).replace('\\','\\\\'))::@5$4=passed($-1)::@6$2=sbe('graphviz-test')::@6$3=sbe('file-exists',filename=filename(@6$2).replace('\\','\\\\'))::@6$4=passed($-1)::@7$2=sbe('ditaa-test')::@7$3=sbe('file-exists',filename=filename($-1).replace('\\','\\\\'))::@7$4=passed($-1)::@4$3=sbe('numlist-sums')::@4$4=passed($-1==10)
