...
** DateTime Functions
   Testing some date and time methods.
    ...
    |           s1           | s2 |   desc   |         result         |   ok   |
    |------------------------+----+----------+------------------------+--------|
    | <2021-03-15 Mon 17:57> |    | now      | <2021-04-18 Sun 23:30> | PASSED |
    |                        |    | minute   | 57                     | PASSED |
    |                        |    | hour     | 17                     | PASSED |
    |                        |    | day      | 15                     | PASSED |
    |                        |    | year     | 2021                   | PASSED |
...
** Range Source and Targets
   Using block ranges to specify destination
    ...
    |  a   |  b   |  c   |  d   |  e   |        |
    |------+------+------+------+------+--------|
    | 0.95 | 0.88 | 0.95 | 0.88 | True | PASSED |
    | 0.77 | 0.50 | 0.77 |  0.5 | True | PASSED |
    | 0.24 | 0.20 | 0.24 |  0.2 | True | PASSED |
    | 0.80 | 0.85 |  0.8 | 0.85 | True | PASSED |
