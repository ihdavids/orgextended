...
** DateTime Functions
   Testing some date and time methods.
    ...
    |           s1           | s2 |   desc   |         result         |   ok   |
    |------------------------+----+----------+------------------------+--------|
    | <2021-03-15 Mon 17:57> |    | now      | <2021-04-03 Sat 21:57> | PASSED |
    |                        |    | minute   | 57                     | PASSED |
    |                        |    | hour     | 17                     | PASSED |
    |                        |    | day      | 15                     | PASSED |
    |                        |    | year     | 2021                   | PASSED |
...
** Range Source and Targets
   Using block ranges to specify destination
    ...
    |  a   |  b   |  c   |  d   |  e   |        |
    |------+------+------+------+------+--------|
    | 0.98 | 0.18 | 0.98 | 0.18 | True | PASSED |
    | 0.89 | 0.50 | 0.89 |  0.5 | True | PASSED |
    | 0.28 | 0.59 | 0.28 | 0.59 | True | PASSED |
    | 0.33 | 0.48 | 0.33 | 0.48 | True | PASSED |
