...
class OrgPlistTestCommand(sublime_plugin.TextCommand):
    def run(self,edit):
        ...
        p = util.PList.createPList(":width 10 :height 20")
        ...
        p = util.PList.createPList(":width 10.5 :height 20.2")
        ...
        p = util.PList.createPList(":param (1 2 3 4) :param2 ( 5 6) :param3 (7 8 )")
